    ...
    public function handle($request, Closure $next)
    {
        ...
        */
        ...
        \Menu::make('admin_sidebar', function ($menu) {
            ...
            // Services
            $menu->add('<i class="c-sidebar-nav-icon fas fa-briefcase"></i>' . trans('oa_menues.backend.sidebar.services'), [
            ...
            // Clients
            $menu->add('<i class="c-sidebar-nav-icon fas fa-users"></i>' . trans('oa_menues.backend.sidebar.clients'), [
                'route' => 'backend.clients.index',
                'class' => 'c-sidebar-nav-item',
            ])
                ->data([
                    'order'         => 99,
                    'activematches' => 'admin/clients*',
                    'permission'    => [],
                ])
                ->link->attr([
                    'class' => 'c-sidebar-nav-link',
            ...
            // Contacts
            $menu->add('<i class="c-sidebar-nav-icon fas fa-comments"></i>' . trans('oa_menues.backend.sidebar.contacts'), [
            ...
            // Partners
            $menu->add('<i class="c-sidebar-nav-icon fas fa-sitemap"></i>' . trans('oa_menues.backend.sidebar.partners'), [
                'route' => 'backend.partners.index',
                'class' => 'c-sidebar-nav-item',
            ])
                ->data([
                    'order'         => 99,
                    'activematches' => 'admin/partners*',
                    'permission'    => [],
                ])
                ->link->attr([
                    'class' => 'c-sidebar-nav-link',
