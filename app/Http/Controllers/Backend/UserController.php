...
class UserController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('response.users');
    ...
    public function profileEdit($id)
    {
        ...
        $module_action = __('response.edit') . ' ' . __('response.profile');
    ...
    public function profileUpdate(Request $request, $id)
    {
        ...
        if ($request->hasFile('avatar')) {
            $data_array['avatar'] =  FileHelper::uploadFile($request->file('avatar'),'users/profiles');
        }
        $data_array['name'] = $request->first_name.' '.$request->last_name;
    ...
    public function changeProfilePasswordUpdate(Request $request, $id)
    {
        ...
        if (!Hash::check($request->get('old_password'), $user->password)) {
            Flash::error(__('response.Old Password is invalid'));
        ...
        Flash::success(icon()." '".Str::singular($module_title)."' ". __('response.update_Successfully'))->important();
