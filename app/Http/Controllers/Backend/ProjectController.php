...
class ProjectController extends Controller
{
    ...
    public function profileUpdate(Request $request, $id)
    {
        ...
        return redirect(route('backend.projects.profile', $$module_name_singular->id));
    }
     ...
     * projects if the softdelete is enabled.
     *
     * @return Response
     */
    ...
    public function emailConfirmationResend($id)
    {
        if ($id != auth()->user()->id) {
            if (auth()->user()->hasAnyRole(['administrator', 'super admin'])) {
                ...
                Log::warning(auth()->user()->name . ' (' . auth()->user()->id . ') - User trying to confirm another projects email.');
