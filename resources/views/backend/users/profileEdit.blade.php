    ...
    <div class="card-body">
        <div class="row">
            <div class="col-8">
                <h4 class="card-title mb-0">
                    <i class="{{$module_icon}}"></i> @lang('response.profile')
            ...
            <div class="col-4">
                <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                    <button onclick="window.history.back();"class="btn btn-warning ml-1" data-toggle="tooltip" title="{{__('response.Return Back')}}"><i class="fas fa-reply"></i></button>
                </div>
            </div>
            <!--/.col-->
        </div>
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                ...
                <div class="form-group row">
                    {{ html()->label(__('labels.backend.users.fields.avatar'))->class('col-md-2 form-control-label')->for('avatar') }}
                
                    <div class="col-md-5">
                        <img id="avatar-preview" src="{{$$module_name_singular->avatar }}" 
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            $required = "required";
                            ?>
                            {{ html()->label(__('labels.backend.users.fields.first_name'), $field_name) }} {!! fielf_required($required) !!}
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            $required = "required";
                            ?>
                            {{ html()->label(__('labels.backend.users.fields.last_name'), $field_name) }} {!! fielf_required($required) !!}
                            {{ html()->text($field_name)->placeholder($field_placeholder)->class('form-control')->attributes(["$required"]) }}
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            $required = "";
                            ?>
                            {{ html()->label(__('labels.backend.users.fields.email'), $field_name) }} {!! fielf_required($required) !!}
