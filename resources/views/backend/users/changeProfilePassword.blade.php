...
<x-backend-breadcrumbs>
    ...
    <x-backend-breadcrumb-item type="active">{{__('response.Change Password')}}</x-backend-breadcrumb-item>
</x-backend-breadcrumbs>
@endsection
        ...
        <div class="row">
            <div class="col-8">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('response.Change Password') </small>
                </h4>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    {{ html()->button($text = "<i class='fas fa-save'></i>" . __('response.save'), $type = 'submit')->class('btn btn-success') }}
                                </div>
                            </div>
                        </div>
                    </div>
