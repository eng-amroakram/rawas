...
<x-backend-breadcrumbs>
    ...
    <x-backend-breadcrumb-item type="active">{{__('response.profile')}}</x-backend-breadcrumb-item>
</x-backend-breadcrumbs>
@endsection
        ...
        <div class="row">
            <div class="col-8">
                <h4 class="card-title mb-0">
                    <i class="{{$module_icon}}"></i> {{__('response.profile')}}
            ...
            <div class="col-4">
                <div class="float-right">
                    <a href="{{ route("backend.users.profileEdit", $user->id) }}" class="btn btn-primary mt-1 btn-sm" data-toggle="tooltip" title="{{__('response.edit')}} {{__('response.profile')}}"><i class="fas fa-wrench"></i> {{__('response.edit')}}</a>
                </div>
            </div>
            <!--/.col-->
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <tr>
                            ...
                            <td><img src="{{$user->avatar}}" class="user-profile-image img-fluid img-thumbnail" style="max-height:200px; max-width:200px;" /></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('backend.users.changeProfilePassword', $user->id) }}" class="btn btn-outline-primary btn-sm">{{__('response.Change Password')}}</a>
                            </td>
                        </tr>
