            ...
            <div class="row">
                ...
                <div class="col-6 col-sm-4">
                    <div class="float-right">
                        <a href='{{ route('backend.projects.works.create', $project->id) }}' class='btn btn-success '
                            data-toggle="tooltip" title="{{ __('response.create') }} {{ __('response.Service') }}">
                        ...
                        <table id="datatable" class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th>{{ __('labels.backend.services.fields.email') }}</th> --}}
                                    {{-- <th>{{ __('labels.backend.services.fields.status') }}</th> --}}
                                    {{-- <th>{{ __('labels.backend.services.fields.roles') }}</th> --}}
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        $('#datatable').DataTable({
            ...
            autoWidth: true,
            responsive: true,
            ajax: '{{ route("backend.$module_name.index_data", $project->id) }}',
            columns: [{
                    data: 'id',
                    name: 'id'
                },
