                ...
                <div class="col-6 col-sm-4">
                    <div class="float-right">
                        <x-buttons.create route='{{ route("backend.$module_name.create") }}'
                            title="{{ __('response.create') }} {{ __('response.client') }}" />
                        ...
                        <table id="datatable" class="table table-hover ">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th>{{ __('labels.backend.clients.fields.email') }}</th> --}}
                                    {{-- <th>{{ __('labels.backend.clients.fields.status') }}</th> --}}
                                    {{-- <th>{{ __('labels.backend.clients.fields.roles') }}</th> --}}
