<header class="c-header c-header-light c-header-fixed c-header-with-subheader">
    ...
    <ul class="c-header-nav ml-auto mr-4" @if(app()->getLocale() == 'ar') style="margin-right: auto !important; margin-left: 1.5rem !important;" @endif>
	...
	{{-- for multilingual implementation --}}
        ...
        <li class="c-header-nav-item dropdown">
            <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="c-avatar">
                    <img class="c-avatar-img" src="{{auth()->user()->avatar}}" alt="{{ auth()->user()->name }}">
                </div>
            </a>
            <div class="dropdown-menu dropdown-menu-right pt-0">
                <div class="dropdown-header bg-light py-2"><strong>@lang('response.Account')</strong></div>
